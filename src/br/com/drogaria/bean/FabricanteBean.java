...
public class FabricanteBean implements Serializable {
	...
	public void salvar() {
		...
		try {
			...
			FacesUtil.addMsgError("Ocorreu erro ao tentar incluir um Fabricante." + e.getMessage());
		}
	...
	public void carregarPesquisa() {
		try {
			...
			FacesUtil.addMsgError("Ocorreu erro ao tentar listar os Fabricantes." + e.getMessage());
		}
	}
	...
	public void carregarCadastro() {
		try {
			...
			FacesUtil.addMsgError("Ocorreu erro ao tentar obter os dados do Fabricante." + e.getMessage());
		}
	}
	...
	public void editar() {
		...
		try {
			...
			FacesUtil.addMsgError("Ocorreu erro ao tentar alterar um Fabricante." + e.getMessage());
		}
	...
	public void excluir() {
		try {
			...
			//Limpa campos
			fabricanteCadastro = new Fabricante();
			FacesUtil.addMsgInfo("Fabricante excluída com sucesso.");
		} catch (RuntimeException e) {
			FacesUtil.addMsgError("Ocorreu erro ao tentar excluir um Fabricante." + e.getMessage());
		}
